...
{
    [super viewDidLoad];
    if([self.nazivKategorije isEqualToString:@"sarma"])
        _slaniRecepti = @[@"Sarma od lipova lisca",@"Mesna sarma od salate locike", @"Sarma sa kiselim kupusom, junecim mesom i rizom", @"Lagana sarma"];
    else
        _slaniRecepti = @[@"Pita zeljanica",@"Sirnica", @"Burek"];
